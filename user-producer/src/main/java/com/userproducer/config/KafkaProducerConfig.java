...
public class KafkaProducerConfig {
    ...
    public NewTopic userCreatedTopic() {
        return new NewTopic(KafkaConstants.USER_CREATED_TOPIC, 3, (short) 1);
    }
    
    @Bean
    public NewTopic userUpdatedTopic() {
        return new NewTopic(KafkaConstants.USER_UPDATED_TOPIC, 3, (short) 1);
    }
    
    @Bean
    public NewTopic userDeletedTopic() {
        return new NewTopic(KafkaConstants.USER_DELETED_TOPIC, 3, (short) 1);
    }
